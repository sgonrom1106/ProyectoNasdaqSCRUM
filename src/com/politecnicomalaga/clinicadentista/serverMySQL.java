...
public class serverMySQL {
	...
	String url = "jdbc:mysql://localhost:3306/seguroIncidenciasJava"; //130.61.62.9
	String username = "java"; //nico
	String password = "javaadmin"; //CURSO2022
	...
	public void test(Oficina oficina) throws SQLException {
